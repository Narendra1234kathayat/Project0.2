  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.patch(
        "https://backend-5h59.onrender.com/api/v1/users/update-account",
      ...
      {userdetail ? (
        <>
          <div className="bg-black border-2 shadow-md rounded-lg overflow-hidden md:flex md:items-center mx-auto max-w-4xl">
            <img
              src={`https://backend-5h59.onrender.com/${userdetail.avatar}`}
            ...
            <div className="p-4 md:flex md:flex-col md:justify-between w-full">
              <div className="mb-4 md:mb-0 md:mr-4">
                <img
                  src={`https://backend-5h59.onrender.com/${userdetail.coverImg}`}
